...
describe('Sessions service', () => {
  ...
  let yggdrasil, SessionsService, testService, storageServiceStub, getCacheStub, setCacheStub, delCacheStub, mockedJWTLib, mockedUuidLib, jwtSignStub, jwtDecodeStub;
  ...
  beforeEach(() => {
    ...
    mockedJWTLib = {
      isMock: true,
      sign: () => {return 'SignedJWT';},
      decode: () => {return 'DecodedJWT';}
    };

    mockedUuidLib = () => {return('ThisIsAnUUID');};

    testService = new SessionsService(yggdrasil, mockedJWTLib, mockedUuidLib);
  ...
  describe('#constructor', () => {
    ...
    it('should use the given uuid lib', () => {
      should(testService.uuid()).eqls('ThisIsAnUUID');
    });
  });
