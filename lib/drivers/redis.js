...
class Redis {
  ...
  async connect() {
    try {
      ...
      this.yggdrasil.logger.info('🗄  Redis Connected.');
      return true;
    } catch (e) {
      if (this.connectionRetries < this.maxRetries) {
        this.yggdrasil.logger.warn('🔄  Cant connect to redis, retrying...');
        this.connectionRetries++;
        return this.connect();
      }
      this.yggdrasil.logger.error(`☠️  Cant connect to redis, retried ${this.maxRetries} times with no success`);
  ...
  disconnect() {
    ...
    this.yggdrasil.logger.info('🔌  Redis is disconnected');
  }
