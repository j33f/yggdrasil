...
constructorR = sandbox.stub();
constructorA = sandbox.stub();
constructorF = sandbox.stub();
constructorU = sandbox.stub();
constructorFoo = sandbox.stub();
