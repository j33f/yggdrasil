...
class Repository {
  ...
  getModel() {
    return Bluebird.resolve(this.model || {});
  }
  ...
  _checkData(object, flattenObject, isNewObject, errors) {
    return validation.checkRequiredProperties(this, flattenObject, errors)
      .then(errors => validation.checkTypesAndCleanup(this, flattenObject, errors))
      .then(errors => validation.checkPropertiesRequiredByPolicies(this, flattenObject, object.policies, errors))
      .then(errors => validation.checkUniqueValues(this, flattenObject, errors, isNewObject))
      .then(errors => {
