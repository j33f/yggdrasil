...
describe('Repository master class', () => {
  ...
  beforeEach(() => {
    ...
    yggdrasil = {
      ...
      uuid: sinon.stub().callsFake(returnString => {
        if (returnString) {
          return 'AnUUID';
        }
  ...
  describe('#create', () => {
    ...
    it('should not call the storage service if check failed', () => {
      ...
      testRepo.checkAndClean = sinon.stub().resolves({errors: 'an error'});
  ...
  describe('#update', () => {
    ...
    it('should not call the storage service if check failed', () => {
      ...
      testRepo.checkAndClean = sinon.stub().resolves({ok: false, errors: {some: 'error'}});
  ...
  describe('#addAttachment', () => {
    it('should call the storage service with the right parameters with only one attachment', () => {
      ...
      storageService.get = sinon.stub().resolves(document);
      storageService.set = sinon.stub().resolves();
      testRepo.checkAndClean = sinon.stub().resolves({ok: true, body: document.body});
    ...
    it('should call the storage service with the right parameters with an array of attachments', () => {
      ...
      storageService.set = sinon.stub().resolves();
      testRepo.checkAndClean = sinon.stub().resolves({ok: true, body: {documents: ['anAttachmentId', 'attachmentId']}});
