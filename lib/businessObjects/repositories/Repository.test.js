...
describe('Repository master class', () => {
  ...
  describe('#topology', () => {
    const
      ...
      methods = ['registerSocketIOListeners', 'registerHTTPRoutes', 'setIndexCollection', 'injectIndexCollection', 'get', 'create', 'update', 'set', 'delete', 'addAttachment', 'list', 'search', 'walk', 'getDistinct', 'cache', 'getCache', 'delCache', 'getModel', 'findDupes', 'checkAndClean'];
