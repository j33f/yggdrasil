...
describe('Repository master class', () => {
  ...
  describe('#topology', () => {
    const
      properties = ['yggdrasil', 'globalConfig', 'name', 'index', 'collection', 'storage', 'model', 'routesAndListeners'],
      methods = ['registerSocketIOListeners', 'registerHTTPRoutes', 'setIndexCollection', 'injectIndexCollection', 'get', 'create', 'update', 'set', 'delete', 'addAttachment', 'list', 'search', 'walk', 'getDistinct', 'cache', 'getCache', 'delCache', 'getModel', 'findDupes', 'checkAndClean', '__checkRequiredProperties', '__checkTypesAndCleanup', '__checkPropertiesRequiredByPolicies', '__checkUniqueValues', '__formatDependingOnPolicy'];
