...
##./node_modules/nyc/bin/nyc.js --temp-directory ./.nyc_output.func --report-dir coverage.functional --reporter=text-summary --reporter=lcov ./bin/startServerInTestingMode &>/dev/null &
...
kill -2 `cat /var/app/yggdrasilTestingServer.pid`

## remove the created pid file
rm /var/app/yggdrasilTestingServer.pid
